...
// GET /reports/agency-wise - Get agency-wise report
...
// GET /reports/block-wise - Get block-wise report
...
// GET /reports/scheme-wise - Get scheme-wise report
...
// GET /reports/pending - Get pending works report
router.get('/pending', [
  query('year').optional().isInt({ min: 2000, max: 2100 }).withMessage('Year must be a valid year')
], async (req, res) => {
  try {
...
// GET /reports/final-status - Get final status of all works
...
// GET /reports/engineer-wise - Get works assigned to an engineer
...
// GET /reports/photo-missing - Get list of works without photos (placeholder)
